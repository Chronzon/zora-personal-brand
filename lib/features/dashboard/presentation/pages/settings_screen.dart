...
class SettingsScreen extends StatelessWidget {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? purpleColor.withOpacity(0.05) : Colors.transparent,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
  ...
  Widget build(BuildContext context) {
    ...
    // Variabel singkatan biar kodenya pendek
    final l10n = AppLocalizations.of(context)!;
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            // --- SECTION 1: ACCOUNT ---
            _buildSectionHeader(l10n.accountSection), // GANTI
            Container(
              color: Colors.white,
              child: Column(
                children: [
                   ListTile(
                    ...
                    title: Text(user.fullName, style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.bold)),
                    subtitle: Text(l10n.starterPlan, style: GoogleFonts.plusJakartaSans(fontSize: 12, color: Colors.grey)), // GANTI
                  ),
